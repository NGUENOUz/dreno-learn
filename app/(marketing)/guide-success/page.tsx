  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] py-20 px-4 md:px-6 font-sans">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        {/* CARTES D'ACTION */}
        <div className="bg-white rounded-[3rem] border border-slate-100 p-8 md:p-12 shadow-2xl shadow-blue-900/5 space-y-10 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            {/* BOUTON PDF */}
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex flex-col space-y-6">
            ...
            {/* BOUTON WHATSAPP */}
            <div className="bg-green-50/50 p-6 rounded-3xl border border-green-100 flex flex-col space-y-6">
        ...
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.5 }} className="bg-slate-900 rounded-[2.5rem] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
